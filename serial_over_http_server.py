...
def main(*args):
    ...
    parser.add_argument('--serial-timeout', type=float, help='Serial timeout')
    parser.add_argument('--write-retry-interval', type=float, help='Retry period in seconds')
    parser.add_argument('--open-retry-interval', type=float, help='Retry period in seconds')
